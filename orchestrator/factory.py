...
def _build_service_registry(cfg=None) -> ServiceRegistry:
    ...
    if cfg.container_lifecycle.enabled:
        ...
        lifecycle_manager = ContainerLifecycleManager(
            ...
            pressure_reap_enabled=cfg.container_lifecycle.pressure_reap_enabled,
            pressure_reap_min_idle_seconds=cfg.container_lifecycle.pressure_reap_min_idle_seconds,
            pressure_reap_max_per_cycle=cfg.container_lifecycle.pressure_reap_max_per_cycle,
