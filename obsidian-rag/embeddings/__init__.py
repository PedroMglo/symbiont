...
def embed_texts(texts: list[str]) -> list[list[float]]:
    ...
    from embeddings.ollama import embed_texts as _embed_texts
...
def get_query_embedding(text: str) -> list[float]:
    ...
    from embeddings.ollama import get_query_embedding as _get_query_embedding
...
def clear_embed_cache() -> None:
    ...
    from embeddings.ollama import clear_embed_cache as _clear_embed_cache
