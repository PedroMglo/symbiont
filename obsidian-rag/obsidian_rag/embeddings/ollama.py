...
class OllamaEmbeddingProvider:
    ...
    def _get_persistent_cache(self):
        ...
        try:
            ...
            from obsidian_rag.embeddings.cache import EmbeddingCache
    ...
    def _embed_texts_cached_with(
        ...
        from obsidian_rag.embeddings.cache import text_sha256
...
# existing ``from obsidian_rag.embeddings.ollama import embed_texts``
