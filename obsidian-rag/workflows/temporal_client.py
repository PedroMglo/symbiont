...
async def _cancel_reprocess_workflow_async(
    workflow_id: str,
    run_id: str = "",
    *,
    settings_obj: Any,
...
def cancel_reprocess_workflow(
    workflow_id: str,
    run_id: str = "",
    *,
    settings_obj: Any = settings,
) -> dict[str, Any]:
    """Request cancellation for a submitted RAG Temporal workflow."""
    return asyncio.run(
        _cancel_reprocess_workflow_async(workflow_id, run_id=run_id, settings_obj=settings_obj)
    )
