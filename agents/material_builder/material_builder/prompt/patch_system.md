...
change context. Prefer a replacement when prior_patch_rejections show
...
- A patch_set is allowed only when allowed_repair_proposals contains
  ...
  expected_current_sha256 and content. Patch-set patches may touch only paths listed
...
- If prior_patch_rejections exist, explicitly account for their reason and diagnostics in the new diff rationale.
